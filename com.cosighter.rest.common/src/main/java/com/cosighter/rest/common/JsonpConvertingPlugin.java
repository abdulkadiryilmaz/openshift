...
public class JsonpConvertingPlugin<T> implements MessageBodyReader<T>, MessageBodyWriter<T> {
    ...
    private JsonValue toJsonValue(Object value, Type targetType) {
        if (value == null) {
           return JsonValue.NULL;
        	...
        	String dateStr = converter.convert(value).to(String.class);
        	return Json.createValue(dateStr);
        } else {
    ...
    private JsonObject toJsonObject(Object o) {
        ...
        Map<String, Object> m = converter.convert(o).sourceAsDTO().to(new TypeReference<Map<String, Object>>(){});
